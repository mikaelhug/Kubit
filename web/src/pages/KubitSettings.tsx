    ...
    <div class="p-6 flex flex-col gap-6 max-w-3xl">
      <Section title="Kubit settings" help="Preferences of this Kubit installation. Cluster-specific settings live under each cluster.">
        ...
        <div class="panel p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          <Field label="Image Factory URL" hint="Where installer images and ISOs come from. Point at a self-hosted factory for air-gapped sites."><input class="input mono" value={s.factoryUrl} onInput={(e) => setS({ ...s, factoryUrl: (e.target as HTMLInputElement).value })} /></Field>
